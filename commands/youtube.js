...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if(!message.member.voice.channel.permissionsFor(message.guild.me).has("CREATE_INSTANT_INVITE"))return client.sendTime(message.channel, "❌ | **Le bot n'a pas l'autorisation de création d'invitation**");
        ...
        .setColor("#FF0000")
        .setDescription(`
        En utilisant **YouTube Together**, vous pouvez regarder YouTube avec vos amis dans une chaîne vocale. Cliquez sur *Rejoindre YouTube Together* pour participer !

__**[Rejoignez YouTube ensemble](https://discord.com/invite/${Invite.code})**__

⚠ **Remarque :** Cela ne fonctionne que sûr PC
`)
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if(!member.voice.channel.permissionsFor(guild.me).has("CREATE_INSTANT_INVITE"))return client.sendTime(interaction, "❌ | ****");
