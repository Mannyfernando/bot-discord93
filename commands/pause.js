...
module.exports = {
    name: "pause",
    description: "Suspend la musique",
    usage: "",
    permissions: {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        player.pause(true);
        let embed = new MessageEmbed().setAuthor(`En pause !`, client.botconfig.IconURL).setColor(client.botconfig.EmbedColor).setDescription(`Taper \`${GuildDB.prefix}resume\` pour continuer à jouer !`);
