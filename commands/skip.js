...
module.exports = {
    name: "skip",
    description: "Ignorer la chanson en cours",
    usage: "",
    permissions: {
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (skipTo !== null && (isNaN(skipTo) || skipTo < 1 || skipTo > player.queue.length)) return client.sendTime(interaction, "❌ | **Numéro invalide à ignorer !**");
            player.stop(skipTo);
            client.sendTime(interaction, "**Ignoré !**");
        },
    },
};
